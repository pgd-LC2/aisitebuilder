...
export default function VersionManager({
  ...
  const handleViewCode = async (file: ProjectFile) => {
    if (!selectedVersion?.code_snapshot) return;

    const code = selectedVersion.code_snapshot[file.file_name];
    if (code) {
      setViewingCode({
  ...
  if (loading) {
    return (
      <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
        <div className="bg-white rounded-xl p-6 max-w-4xl w-full max-h-[80vh] flex items-center justify-center">
  ...
  return (
    <>
      ...
      <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
        <div className="bg-white rounded-xl max-w-6xl w-full max-h-[85vh] flex flex-col shadow-xl">
                      ...
                      {selectedFile && (
                        <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
                          ...
                          <div className="text-xs text-gray-600 mb-3">
                            <p>路径: <code className="bg-white px-2 py-1 rounded">{selectedFile.file_path}</code></p>
                          </div>
